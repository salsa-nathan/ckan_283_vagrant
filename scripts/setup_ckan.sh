...
echo -e "${NC}${HIGHLIGHT} ##################################################################### ${NC}"
echo -e "--- ${HIGHLIGHT} 4. Configure Solr ${NC} --- "
echo -e "${HIGHLIGHT} ##################################################################### ${NC}"
...
echo -e "${NC}${HIGHLIGHT} ##################################################################### ${NC}"
echo -e "--- ${HIGHLIGHT} 5. Link who.ini ${NC} --- "
echo -e "${HIGHLIGHT} ##################################################################### ${NC}"
...
echo -e "${NC}${HIGHLIGHT} ##################################################################### ${NC}"
echo -e "--- ${HIGHLIGHT} 6. Initialise the CKAN DB ${NC} --- "
echo -e "${HIGHLIGHT} ##################################################################### ${NC}"
...
echo -e "${NC}${HIGHLIGHT} ##################################################################### ${NC}"
echo -e "--- ${HIGHLIGHT} 7. Setup Datastore ${NC} --- "
echo -e "${HIGHLIGHT} ##################################################################### ${NC}"
...
echo -e "${NC}${HIGHLIGHT} ##################################################################### ${NC}"
echo -e "--- ${HIGHLIGHT} 8. Create salsa as sysadmin user ${NC} --- "
...
echo -e "${NC}${HIGHLIGHT} ##################################################################### ${NC}"
echo -e "--- ${HIGHLIGHT} 9. Run following commands to start CKAN ${NC} --- "
